        ...
        {cells.map((cell, i) => {
          ...
          return (
            <button
              ...
              aria-label={`${cell.date}, ${statusLabel[cell.status]}${cell.totalPunches ? `, ${cell.totalPunches} punches` : ''}`}
              className={cn(
                'aspect-square rounded-md border text-xs font-medium flex flex-col items-center justify-center transition-colors hover:opacity-80',
